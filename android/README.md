...
- List agent chat sessions, open chat history, send prompts, answer question/permission cards, render common transcript cards, and apply `chat.message` push updates in the WebView.
