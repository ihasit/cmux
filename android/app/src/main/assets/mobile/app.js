...
const messages = {
  en: {
    ...
    "terminal.key.ctrlA": "Ctrl-A",
    "terminal.key.ctrlC": "Ctrl-C",
    "terminal.key.ctrlD": "Ctrl-D",
    "terminal.key.ctrlE": "Ctrl-E",
    "terminal.key.ctrlL": "Ctrl-L",
    "terminal.key.ctrlU": "Ctrl-U",
    "terminal.key.ctrlW": "Ctrl-W",
...
function renderTerminalFrame(rawFrame, options = {}) {
  ...
  if (!options.reset && existing && frame.stateSeq > 0 && existing.stateSeq > frame.stateSeq) {
    return;
  }
